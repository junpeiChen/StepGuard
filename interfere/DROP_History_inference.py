...
DEFAULT_INPUT_DATA = os.path.join(DEFAULT_TOKEN_GUARD_ROOT, "data", "DROP_History.json")
DEFAULT_OUTPUT_PATH = os.path.join(REPO_ROOT, "advance", "drop_history", "results", "DROP_History_stepguard_results.json")
...
def load_inference_module():
    ...
    spec = importlib.util.spec_from_file_location("drop_history_inference_core", INFERENCE_PATH)
