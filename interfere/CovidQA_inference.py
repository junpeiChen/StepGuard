...
DEFAULT_INPUT_DATA = os.path.join(DEFAULT_TOKEN_GUARD_ROOT, "data", "CovidQA.json")
DEFAULT_OUTPUT_PATH = os.path.join(REPO_ROOT, "advance", "covidqa", "results", "CovidQA_stepguard_results.json")
...
def load_inference_module():
    ...
    spec = importlib.util.spec_from_file_location("covidqa_inference_core", INFERENCE_PATH)
...
def main():
    ensure_default_flag("--dataset_name", "covidQA")
