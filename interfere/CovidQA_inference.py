...
DEFAULT_INPUT_DATA = os.path.join(STEPGUARD_ROOT, "data", "CovidQA.json")
DEFAULT_OUTPUT_PATH = os.path.join(SCRIPT_DIR, "results", "CovidQA_stepguard_results11.json")
...
def load_inference_module():
    ...
    spec = importlib.util.spec_from_file_location("covidqa_inference_core", INTERFERE_PATH)
