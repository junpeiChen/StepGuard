...
DEFAULT_INPUT_DATA = os.path.join(STEPGUARD_ROOT, "data", "Halueval.json")
DEFAULT_OUTPUT_PATH = os.path.join(SCRIPT_DIR, "results", "Halueval_stepguard_results-11.json")
...
def load_inference_module():
    ...
    spec = importlib.util.spec_from_file_location("halueval_inference_core", INTERFERE_PATH)
