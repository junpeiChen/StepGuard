...
DEFAULT_INPUT_DATA = os.path.join(STEPGUARD_ROOT, "data", "PubmedQA.json")
DEFAULT_OUTPUT_PATH = os.path.join(SCRIPT_DIR, "results", "PubmedQA_stepguard_results.json")
...
def load_inference_module():
    ...
    spec = importlib.util.spec_from_file_location("pubmedqa_inference_core", INTERFERE_PATH)
