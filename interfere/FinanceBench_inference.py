...
DEFAULT_INPUT_DATA = os.path.join(DEFAULT_TOKEN_GUARD_ROOT, "data", "FinanceBench.json")
DEFAULT_OUTPUT_PATH = os.path.join(REPO_ROOT, "advance", "financebench", "results", "FinanceBench_stepguard_results.json")
...
def load_inference_module():
    ...
    spec = importlib.util.spec_from_file_location("financebench_inference_core", INFERENCE_PATH)
...
def main():
    ensure_default_flag("--dataset_name", "financebench")
