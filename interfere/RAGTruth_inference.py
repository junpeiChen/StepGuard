...
DEFAULT_INPUT_DATA = os.path.join(DEFAULT_TOKEN_GUARD_ROOT, "data", "RAGTruth.json")
DEFAULT_OUTPUT_PATH = os.path.join(REPO_ROOT, "advance", "ragtruth", "results", "RAGTruth_stepguard_results.json")
...
def load_inference_module():
    ...
    spec = importlib.util.spec_from_file_location("ragtruth_inference_core", INFERENCE_PATH)
...
def main():
    ensure_default_flag("--dataset_name", "ragtruth")
    ...
    ensure_default_flag("--max_new_tokens", "8192")
    ensure_default_flag("--max_input_tokens", "6144")
